...
--
-- Host: localhost
-- Generation Time: Mar 18, 2015 at 08:07 PM
...
--
-- Table structure for table `zfp49_assets`
--

CREATE TABLE IF NOT EXISTS `zfp49_assets` (
...
--
-- Dumping data for table `zfp49_assets`
--

INSERT INTO `zfp49_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `zfp49_associations`
--

CREATE TABLE IF NOT EXISTS `zfp49_associations` (
...
--
-- Table structure for table `zfp49_banners`
--

CREATE TABLE IF NOT EXISTS `zfp49_banners` (
...
--
-- Table structure for table `zfp49_banner_clients`
--

CREATE TABLE IF NOT EXISTS `zfp49_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `zfp49_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `zfp49_banner_tracks` (
...
--
-- Table structure for table `zfp49_categories`
--

CREATE TABLE IF NOT EXISTS `zfp49_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zfp49_categories`
--

INSERT INTO `zfp49_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 470, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_contact_details`
--

CREATE TABLE IF NOT EXISTS `zfp49_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `zfp49_content`
--

CREATE TABLE IF NOT EXISTS `zfp49_content` (
...
--
-- Dumping data for table `zfp49_contentitem_tag_map`
--

INSERT INTO `zfp49_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `zfp49_content_frontpage` (
...
--
-- Table structure for table `zfp49_content_rating`
--

CREATE TABLE IF NOT EXISTS `zfp49_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `zfp49_content_types`
--

CREATE TABLE IF NOT EXISTS `zfp49_content_types` (
...
--
-- Dumping data for table `zfp49_content_types`
--

INSERT INTO `zfp49_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `zfp49_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `zfp49_core_log_searches` (
...
--
-- Table structure for table `zfp49_extensions`
--

CREATE TABLE IF NOT EXISTS `zfp49_extensions` (
...
--
-- Dumping data for table `zfp49_extensions`
--

INSERT INTO `zfp49_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"d436a232ea60d919250d1ae92ad93433"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `zfp49_finder_filters`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_filters` (
...
--
-- Table structure for table `zfp49_finder_links`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links` (
...
--
-- Table structure for table `zfp49_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms0` (
...
--
-- Table structure for table `zfp49_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `zfp49_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `zfp49_finder_taxonomy`
--

INSERT INTO `zfp49_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `zfp49_finder_terms`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_terms` (
...
--
-- Table structure for table `zfp49_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `zfp49_finder_terms_common`
--

INSERT INTO `zfp49_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `zfp49_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `zfp49_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `zfp49_finder_types`
--

CREATE TABLE IF NOT EXISTS `zfp49_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `zfp49_languages`
--

CREATE TABLE IF NOT EXISTS `zfp49_languages` (
...
--
-- Dumping data for table `zfp49_languages`
--

INSERT INTO `zfp49_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_menu`
--

CREATE TABLE IF NOT EXISTS `zfp49_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zfp49_menu`
--

INSERT INTO `zfp49_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `zfp49_menu_types`
--

CREATE TABLE IF NOT EXISTS `zfp49_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zfp49_menu_types`
--

INSERT INTO `zfp49_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `zfp49_messages`
--

CREATE TABLE IF NOT EXISTS `zfp49_messages` (
...
--
-- Table structure for table `zfp49_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `zfp49_messages_cfg` (
...
--
-- Table structure for table `zfp49_modules`
--

CREATE TABLE IF NOT EXISTS `zfp49_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `zfp49_modules`
--

INSERT INTO `zfp49_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `zfp49_modules_menu`
--

CREATE TABLE IF NOT EXISTS `zfp49_modules_menu` (
...
--
-- Dumping data for table `zfp49_modules_menu`
--

INSERT INTO `zfp49_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `zfp49_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `zfp49_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `zfp49_overrider`
--

CREATE TABLE IF NOT EXISTS `zfp49_overrider` (
...
--
-- Table structure for table `zfp49_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `zfp49_postinstall_messages` (
...
--
-- Dumping data for table `zfp49_postinstall_messages`
--

INSERT INTO `zfp49_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `zfp49_redirect_links`
--

CREATE TABLE IF NOT EXISTS `zfp49_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `zfp49_schemas`
--

CREATE TABLE IF NOT EXISTS `zfp49_schemas` (
...
--
-- Dumping data for table `zfp49_schemas`
--

INSERT INTO `zfp49_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-01-21');

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_session`
--

CREATE TABLE IF NOT EXISTS `zfp49_session` (
...
--
-- Dumping data for table `zfp49_session`
--

INSERT INTO `zfp49_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('aiui44ibr50g5vab5c746j52d7', 1, 0, '1426683380', '__default|a:8:{s:15:"session.counter";i:4;s:19:"session.timer.start";i:1426683360;s:18:"session.timer.last";i:1426683368;s:17:"session.timer.now";i:1426683372;s:22:"session.client.browser";s:113:"Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.89 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"470";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:24:"ngvantrinh2010@gmail.com";s:8:"password";s:60:"$2y$10$6YOwslWO3ygr9PqCrcUqluxZ8QhmqT9jLis2dV250tmbyHB.hEWB6";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-03-18 06:00:39";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"b4fe0ecacde69573bd6a8243a29b8c06";}', 470, 'admin'),
('h8mreh8ilvvthc3hkjqkjra551', 0, 1, '1426683321', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1426683312;s:18:"session.timer.last";i:1426683312;s:17:"session.timer.now";i:1426683312;s:22:"session.client.browser";s:113:"Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.89 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"b2b71fab85946a95f76f124e7428238c";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_tags`
--

CREATE TABLE IF NOT EXISTS `zfp49_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `zfp49_tags`
--

INSERT INTO `zfp49_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 470, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 470, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_template_styles`
--

CREATE TABLE IF NOT EXISTS `zfp49_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zfp49_template_styles`
--

INSERT INTO `zfp49_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `zfp49_ucm_base`
--

CREATE TABLE IF NOT EXISTS `zfp49_ucm_base` (
...
--
-- Dumping data for table `zfp49_ucm_base`
--

INSERT INTO `zfp49_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_ucm_content`
--

CREATE TABLE IF NOT EXISTS `zfp49_ucm_content` (
...
--
-- Dumping data for table `zfp49_updates`
--

INSERT INTO `zfp49_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(3, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(4, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(5, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.4.0.2', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(6, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(7, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(8, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.3.3.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(9, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(15, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.4.0.3', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
...
(18, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(19, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(20, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(21, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(22, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(23, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(24, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.3.4.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(25, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(26, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(27, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(28, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(29, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.4.0.3', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
...
(34, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(35, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
...
(38, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.4.0.2', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(39, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
...
(44, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.0.3', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(45, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
...
(48, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(51, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(52, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.0.2', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
...
--
-- Table structure for table `zfp49_update_sites`
--

CREATE TABLE IF NOT EXISTS `zfp49_update_sites` (
...
--
-- Dumping data for table `zfp49_update_sites`
--

INSERT INTO `zfp49_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1426683374, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1426683373, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1426683373, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1426683373, '');

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `zfp49_update_sites_extensions` (
...
--
-- Dumping data for table `zfp49_update_sites_extensions`
--

INSERT INTO `zfp49_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `zfp49_usergroups`
--

CREATE TABLE IF NOT EXISTS `zfp49_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `zfp49_usergroups`
--

INSERT INTO `zfp49_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `zfp49_users`
--

CREATE TABLE IF NOT EXISTS `zfp49_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `zfp49_users`
--

INSERT INTO `zfp49_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(470, 'Super User', 'admin', 'ngvantrinh2010@gmail.com', '$2y$10$6YOwslWO3ygr9PqCrcUqluxZ8QhmqT9jLis2dV250tmbyHB.hEWB6', 0, 1, '2015-03-18 06:00:39', '2015-03-18 12:56:07', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_user_keys`
--

CREATE TABLE IF NOT EXISTS `zfp49_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `zfp49_user_notes`
--

CREATE TABLE IF NOT EXISTS `zfp49_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `zfp49_user_profiles`
--

CREATE TABLE IF NOT EXISTS `zfp49_user_profiles` (
...
--
-- Table structure for table `zfp49_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `zfp49_user_usergroup_map` (
...
--
-- Dumping data for table `zfp49_user_usergroup_map`
--

INSERT INTO `zfp49_user_usergroup_map` (`user_id`, `group_id`) VALUES
(470, 8);

-- --------------------------------------------------------

--
-- Table structure for table `zfp49_viewlevels`
--

CREATE TABLE IF NOT EXISTS `zfp49_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `zfp49_viewlevels`
--

INSERT INTO `zfp49_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
